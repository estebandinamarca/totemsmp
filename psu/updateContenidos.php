...
if($_POST)
{
	...
	{
		case "desc":
			$url  = 'http://www.mallplaza.cl/xml/descuentos.php?siteid=mallplaza-sur';
			...
			break;
		case "cine":
			$url  = 'http://www.mallplaza.cl/xml/cine.php?siteid=mallplaza-sur';
			...
			break;
		case "evento":
			$url  = 'http://www.mallplaza.cl/xml/eventos.php?siteid=mallplaza-sur';
