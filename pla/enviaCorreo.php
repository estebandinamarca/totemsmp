...
if($face==null)
{
  $subject = "Correo desde Mall Plaza La Serena ($tipo)";
  $body = "El siguiente mensaje fue enviado desde el totem T1 en Mall Plaza La Serena con el siguiente mensaje:\n
