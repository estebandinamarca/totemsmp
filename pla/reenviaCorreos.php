...
if(count($correos)>0)
{
	...
	$from_name = "Mall Plaza La Serena";
	$from_email = "mensajes.mallplaza@gmail.com";
	$headers = "From: $from_name <$from_email>";
	$subject = "Correos no enviados desde Mall Plaza La Serena";
	$body = "Los siguientes correos no fueron enviados en el dia de su generacion desde Mall Plaza La Serena, estos son:\n\n";
