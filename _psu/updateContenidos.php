...
if($_POST)
{
	...
	{
		case "desc":
			$url  = 'http://www.mallplaza.cl/xml/descuentos.php?siteid=mallplaza-calama';
			...
			break;
		case "cine":
			$url  = 'http://www.mallplaza.cl/xml/cine.php?siteid=mallplaza-calama';
			...
			break;
		case "evento":
			$url  = 'http://www.mallplaza.cl/xml/eventos.php?siteid=mallplaza-calama';
