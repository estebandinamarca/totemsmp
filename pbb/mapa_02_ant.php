		...
		<script>
			...
			function init() {
				...
				for (i=0; i<o; i++){
					...
					if( scene.__objects[i].name === "Piso" ){
		        ...
		        sRutaBase = new THREE.MeshBasicMaterial({ color: 0xeeaaaa });
				sRutaOn   = new THREE.MeshBasicMaterial({ color: 0xff0000 });
		        ...
		        var mLinea1 = new THREE.Geometry()
				mLinea1.vertices.push( new THREE.Vector3( 259, 2, -201 ) );
				mLinea1.vertices.push( new THREE.Vector3( 259, 100, -201 ) );

		        var linea1 = new THREE.Line( mLinea1, sLineas );
				scene.add( linea1 );


				var mLinea2 = new THREE.Geometry()
				mLinea2.vertices.push( new THREE.Vector3( 360, 2, -199 ) );
				mLinea2.vertices.push( new THREE.Vector3( 360, 100, -199 ) );

		        var linea2 = new THREE.Line( mLinea2, sLineas );
				scene.add( linea2 );
				...
				spHudInicio.scale.x = 0.2
				spHudInicio.scale.y = 0.1;
				spHudInicio.position.set( 360, 100, -199 );
				scene.add( spHudInicio );

				var spHudDestino = new THREE.Sprite( { map: iHudDestino, useScreenCoordinates: false, color: 0xffffff } );
				spHudDestino.scale.x = 0.2
				spHudDestino.scale.y = 0.1;
				spHudDestino.position.set( 259, 100, -201 );
			...
			function prepare() {
				...
				loader.load( "src/js/mapa/v04_06.js", callbackFinished );
