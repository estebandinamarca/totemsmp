var jsKeyboard = {
    ...
    show: function() {
        $("#keyboard").animate({ "bottom": "300px" }, "slow", function() { });
    },
    hide: function() {
    ...
    defaultKeyboard: {
        ...
        // 2nd row
               ...
               { value: "Listo", isChar: "false", buttonClass: "button button_enter", onclick: "jsKeyboard.hide();", keyClass: "key key_enter" },
        // 3rd row
        ...
        // 3rd row
                ...
                { value: 110 },{ value: 109 },{ value: 46 },{ value: 95 },{ value: 64 },
        // 4th row
                { value: "123", isChar: "false", buttonClass: "button button_numberleft", onclick: "jsKeyboard.changeToNumber();", keyClass: "key key_number" },
                { value: 32, buttonClass: "button button_space" },
                //{ value: 112 ,  buttonClass: "button button_symbolsright"}
			    {value: "#$@", isChar: "false", buttonClass: "button button_symbolsright", onclick: "jsKeyboard.changeToSymbols();", keyClass: "key key_symbols" }
        ...
        // 2nd row
                ...
                { value: "Listo", isChar: "false", buttonClass: "button button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        //3rd row
                { value: "ABC", isChar: "false", buttonClass: "button button_capitalletterleft", onclick: "jsKeyboard.changeToCapitalLetter()", keyClass: "key key_capitalletterleft" },
